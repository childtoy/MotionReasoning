...
def motnet(drop_path_rate=0.):
    model = MotionTransformer(
        seq_len=60, in_chans=35, num_classes=7, embed_dim=35, depth=12, num_heads=7, mlp_ratio=4,
        qkv_bias=True, drop_path_rate=drop_path_rate, norm_layer=partial(nn.LayerNorm, eps=1e-6))
    return model
