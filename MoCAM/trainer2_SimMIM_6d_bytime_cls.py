...
def train(opt, device):
    ...
    mot = MoT_6d(seq_len = num_joints, num_joints=seq_len, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/SIM_MIM_MOT_6D_time4/weights/train-1000.pt', help='pretrained weight path')        
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_6D_time_cls', help='save to project/name')
