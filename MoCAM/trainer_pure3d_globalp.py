...
def train(opt, device):
    ...
    selected_joint = [0,3,4,7,8,11,14,15,18,21,22,25,28,29,32]
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='conv2d_globalp_scaled', help='save to project/name')
