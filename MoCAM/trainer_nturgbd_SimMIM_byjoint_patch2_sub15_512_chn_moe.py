...
def train(opt, device):
    ...
    mim = SimMIM_patch2_seg_chn_moe( encoder = mot, masking_ratio = 0.5)
    mim.to(device)
    mim.train()
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='nturgbd_SIM_MIM_MOT_patch2_sub30_512_chn_moe', help='save to project/name')
