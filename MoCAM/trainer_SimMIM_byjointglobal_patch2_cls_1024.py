...
def parse_opt():
    ...
    # parser.add_argument('--weight_path', type=str, default='runs/train/SIM_MIM1024_MOT_jointglobalppatch20_22/weights/train-1000.pt', help='pretrained weight path')
    ...
    parser.add_argument('--exp_name', default='SIM_MIM512_MOT_jointglobalppatch20_2_cls_nopre', help='save to project/name')
