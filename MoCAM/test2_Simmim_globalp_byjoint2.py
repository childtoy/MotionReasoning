...
def test(opt, device):
    ...
    model = MoT_pos2(seq_len = seq_len, num_joints=num_joints*3, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_norm2_globalp_2_cls2', help='experiment name')
