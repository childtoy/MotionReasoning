...
for i in selected_joint:
    selected_joint_names.append(joint_names[i])
for i in range(15):
    save_path = os.path.join('result_2classAH_3c_val_heatmap', origin_data['filename'][i].split('.mat')[0])
    ...
    gif_path = os.path.join('result_2classAH_3c_val_heatmap', str(origin_data['filename'][i].split('.mat')[0])+'_'+str(origin_data['start_frame'][i].numpy())+'_'+prdstr+'.gif')
