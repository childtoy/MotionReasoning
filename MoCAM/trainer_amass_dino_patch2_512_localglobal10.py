...
from motion.dataset.amass import AMASSDataset
...
def lerp_input_repr(input, valid_len, seq_len, mode):
    if mode == 'global':
        ...
        select_const = np.random.randint(6,8,[1])
...
def train(opt):
    ...
    train_dataset = AMASSDataset('../dataset', 'babel_v1.0_release', dataset='train', target_fps=30, motion_length=150, transform=transform)
