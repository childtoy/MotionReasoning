...
def train(opt, device):
    ...
    print(emotion_dataset.data['mean_q'])
    print(emotion_dataset.data['std_q'])
    ...
    mot = MoT_patch2(seq_len = seq_len, num_joints=num_joints, sub_seq=20, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
...
def parse_opt():
    ...
    parser.add_argument('--processed_data_dir', type=str, default='processed_data_mocam_80_All_Class_norm4/', help='path to save pickled processed data')
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_patch2_512', help='save to project/name')
