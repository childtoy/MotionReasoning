...
from data_proc.emotionmocap_dataset_bvh import EmotionDataset
...
def train(opt, device):
    ...
    n_classes = 2
    input_channels = 21*4* opt.window
    input_channels = 6720
...
def parse_opt():
    ...
    parser.add_argument('--data_path', type=str, default='/home/taehyun/workspace/childtoy/MotionReasoning/dataset/mocap_emotion/BVH', help='Mat dataset path')
