...
def lerp_input_repr(input, target_seqs, target_joints, seq_len):
    ...
    for joint_idx, start_seq in zip(target_joints, target_seqs):
        ...
        output[start_seq:start_seq+seq_len, joint_idx:joint_idx+1] =  torch.zeros([20,1])
    return output
...
image_path = None
image_size = (480,480)
output_dir = 'SIM_MIM_MOT_addR_joint_cls4_random_zero'
threshold = None
project = 'runs/train'
weight = 'latest'
...
save_dir = './result_attention_patch2_val_random_all'
pbar = tqdm(emotion_data_loader, position=1, desc="Batch")
correct = 0
correct1 = 0
correct2 = 0
