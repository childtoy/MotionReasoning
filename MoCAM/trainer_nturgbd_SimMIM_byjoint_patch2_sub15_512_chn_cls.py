...
def train(opt, device):
    ...
    mot = MoT_patch2_seg_chn(seq_len = seq_len, num_joints=num_joints, sub_seq=15, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/nturgbd_SIM_MIM_MOT_patch2_sub15_512_chn_head1/weights/train-100.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='nturgbd_SIM_MIM_MOT_patch2_chn_512_cls_head1', help='save to project/name')
