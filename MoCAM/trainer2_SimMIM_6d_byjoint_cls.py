...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/SIM_MIM_MOT_norm2_6D/weights/train-1000.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_6D_norm2_cls', help='save to project/name')
