...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/nturgbd_SIM_MIM_MOT_patch2_sub15_512/weights/train-100.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='nturgbd_SIM_MIM_MOT_patch2_512_cls', help='save to project/name')
