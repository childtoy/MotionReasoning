...
def train(opt, device):
    ...
    mot = MoT_pos2(seq_len = seq_len, num_joints=num_joints*3, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/SIM_MIM_MOT_norm2_globalp_2/weights/train-1000.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_norm2_globalp_2_cls', help='save to project/name')
