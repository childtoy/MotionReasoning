...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/SIM_MIM_MOT38/weights/train-1000.pt', help='pretrained weight path')
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_joint_cls_nopre_512', help='save to project/name')
