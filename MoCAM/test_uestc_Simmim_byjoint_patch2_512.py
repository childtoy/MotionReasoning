...
def test(opt, device):
    ...
    # Load LAFAN Dataset
    test_dataset =  UESTCDataset(data_path="../dataset/experiment/uestc", dataset="train")
...
def parse_opt():
    ...
    parser.add_argument('--weight', default='100')
    parser.add_argument('--exp_name', default='uestc_SIM_MIM_MOT_patch2_512_cls10', help='experiment name')
