...
image_path = None
image_size = (480,480)
output_dir = 'humanact12_SIM_MIM_MOT_patch2_512_mean_chn'
threshold = None
project = 'runs/train'
weight = '700'

exp_name='humanact12_SIM_MIM_MOT_patch2_512_mean_chn'
data_path=''
window=150
batch_size=128
save_path='runs/test'
...
mot_dim_head = 64
target_joint = 'joint'
model = MoT_patch2_seg(seq_len = seq_len, num_joints=num_joints, sub_seq=30, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim, pool='mean')
...
for exam_idx in range(119):
    ...
    i=0
    save_path = os.path.join('humanact12_patch_val_mean')
    ...
    gif_path = os.path.join('humanact12_patch_val_mean','humanact12_patch_val_mean'+str(prefixx)+'.gif')
