...
def train(opt, device):
    ...
    train_dataset = NTURGBDDataset2(data_path="../dataset/experiment/nturgbd/ntu_vibe/", motion_length=150, dataset="train", transform=None)
...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/nturgbd_SIM_MIM_MOT_patch2_512_chn5/weights/train-100.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='nturgbd_SIM_MIM_MOT_patch2_chn_512_cls', help='save to project/name')
