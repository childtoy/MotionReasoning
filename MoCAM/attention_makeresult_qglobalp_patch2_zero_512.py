...
image_path = None
image_size = (480,480)
output_dir = 'SIM_MIM512_MOT_jointglobalppatch20_2_cls2'
threshold = None
project = 'runs/train'
weight = '500'

exp_name='SIM_MIM512_MOT_jointglobalppatch20_2_cls2'
data_path=''
window=80
batch_size=1
...
save_dir = './result_attention_patch2_val_zero_pad_512'
pbar = tqdm(emotion_data_loader, position=1, desc="Batch")
correct = 0
correct1 = 0
correct2 = 0
