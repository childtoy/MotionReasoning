...
def train(opt, device):
    ...
    mot = MoT_patch2_seg_chn(seq_len = seq_len, num_joints=num_joints, sub_seq=30, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim, pool='mean')
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='nturgbd_SIM_MIM_MOT_patch2_sub30_chn_512_pool_head8', help='save to project/name')
