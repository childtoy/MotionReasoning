...
image_path = None
image_size = (480,480)
output_dir = 'nturgbd_SIM_MIM_MOT_patch2_chn_512_cls'
threshold = None
project = 'runs/train'
weight = '400'

exp_name='nturgbd_SIM_MIM_MOT_patch2_chn_512_cls'
data_path=''
window=150
batch_size=128
save_path='runs/test'
...
for exam_idx in range(119):
    ...
    i=0
    save_path = os.path.join('nturgbd_patch_chn_val')
    ...
    gif_path = os.path.join('nturgbd_patch_chn_val','nturgbd_patch_chn_val_'+str(prefixx)+'.gif')
