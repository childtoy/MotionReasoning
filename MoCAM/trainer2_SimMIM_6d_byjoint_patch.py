...
from model.MoT import MoT_patch_6d
from model.SImMIM import SimMIM_patch
def train(opt, device):
    ...
    mot = MoT_patch_6d(seq_len = seq_len, num_joints=num_joints, sub_seq=20, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim, channels=6)
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_6D_patch', help='save to project/name')
