...
from model.MoT import MoT_pos2
from model.SImMIM import SimMIM_pos2
def train(opt, device):
    ...
    mot = MoT_pos2(seq_len = num_joints, num_joints=seq_len*3, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
    mim = SimMIM_pos2( encoder = mot, masking_ratio = 0.5)
...
def parse_opt():
    ...
    parser.add_argument('--processed_data_dir', type=str, default='processed_data_mocam_80_All_Class_addR/', help='path to save pickled processed data')
    parser.add_argument('--window', type=int, default=80, help='window')
    parser.add_argument('--weight_path', type=str, default='runs/train/SIM_MIM_MOT_globalp_23/weights/train-1000.pt', help='pretrained weight path')    
    parser.add_argument('--wandb_pj_name', type=str, default='MoCAM', help='project name')
    parser.add_argument('--batch_size', type=int, default=128, help='batch size')
    parser.add_argument('--epochs', type=int, default=1000)
    parser.add_argument('--device', default='0', help='cuda device')
    parser.add_argument('--entity', default=None, help='W&B entity')
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_globalp_time_2', help='save to project/name')
