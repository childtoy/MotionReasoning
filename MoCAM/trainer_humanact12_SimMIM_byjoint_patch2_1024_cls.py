...
def train(opt, device):
    ...
    for epoch in range(1, epochs + 1):
        ...
        for batch in pbar:
            ...
            loss.backward()
            # torch.nn.utils.clip_grad_norm_(mim.parameters(), 2.0)
...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/humanact12_SIM_MIM_MOT_patch2_1024_head1/weights/train-100.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='humanact12_SIM_MIM_MOT_patch2_1024_cls_head1', help='save to project/name')
