...
def train(opt, device):
    ...
    mot = MoT_6d2(seq_len = num_joints, num_joints=seq_len*6, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
    ...
    for epoch in range(1, epochs + 1):
        ...
        for batch in pbar:
            ...
            local_R = local_R[:,:,selected_joint,:]
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_6D_time_2', help='save to project/name')
