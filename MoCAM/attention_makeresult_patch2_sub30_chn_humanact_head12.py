...
image_path = None
image_size = (480,480)
output_dir = 'humanact12_SIM_MIM_MOT_patch2_512_sub30_cls_chn_head'
threshold = None
project = 'runs/train'
weight = '1000'

exp_name='humanact12_SIM_MIM_MOT_patch2_512_sub30_cls_chn_head'
data_path=''
window=150
batch_size=128
save_path='runs/test'
...
for exam_idx in range(119):
    ...
    save_path = os.path.join('humanact12_patch_sub30_head1_chn_val_heatmapcont')
    ...
    gif_path = os.path.join('humanact12_patch_sub30_head1_chn_val_heatmapcont','humanact12_patch_sub30_head1_chn_val_heatmapcont'+str(prefixx)+'.gif')
