...
for exam_idx in range(119):
    ...
    save_path = os.path.join('humanact12_patch_sub15_head1_chn_val_heatmapcont')
    ...
    gif_path = os.path.join('humanact12_patch_sub15_head1_chn_val_heatmapcont','humanact12_patch_sub15_head1_chn_val_heatmapcont'+str(prefixx)+'.gif')
