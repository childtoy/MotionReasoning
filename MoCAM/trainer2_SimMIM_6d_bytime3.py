...
def train(opt, device):
    ...
    mot = MoT_6d3(seq_len = num_joints, num_joints=seq_len*6, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_6D_noprej_nolin', help='save to project/name')
