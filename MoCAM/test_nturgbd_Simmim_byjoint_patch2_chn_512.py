...
def test(opt, device):
    ...
    # Load LAFAN Dataset
    transform = None
    test_dataset = NTURGBDDataset2(data_path="../dataset/experiment/nturgbd/ntu_vibe/", motion_length=150, dataset="test", transform=transform)    
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='nturgbd_SIM_MIM_MOT_patch2_chn_512_cls3', help='experiment name')
