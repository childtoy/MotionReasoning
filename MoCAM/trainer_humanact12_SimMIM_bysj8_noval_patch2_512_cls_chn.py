...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/humanact12_SIM_MIM_MOT_patch2_sj8_noval_512_noaug/weights/train-100.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='humanact12_SIM_MIM_MOT_patch2_sj8_noval_512_ssl_noaug_cls_noaug', help='save to project/name')
