...
def test(opt, device):
    ...
    model = MoT_6d2(seq_len = seq_len, num_joints=num_joints*6, num_classes=n_classes,  dim=mot_dim, depth=mot_depth, heads=mot_heads, mlp_dim = mot_mlp_dim)
    # mim = SimMIM_6d2( encoder = n, masking_ratio = 0.5)
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT_6D_norm2_2_cls8', help='experiment name')
