...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', default='SIM_MIM_MOT31_time_cls14', help='experiment name')
    ...
    model = SimMIM( encoder = mot, masking_ratio = 0.5)
    model.load_state_dict(ckpt['SimMIM'])
    ...
    for j in range(nh):
        fname = os.path.join(args.output_dir, "time-attn-head" + str(j) + ".png")
