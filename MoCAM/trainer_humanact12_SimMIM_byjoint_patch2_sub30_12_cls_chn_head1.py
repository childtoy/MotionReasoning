...
def parse_opt():
    ...
    parser.add_argument('--weight_path', type=str, default='runs/train/humanact12_SIM_MIM_MOT_patch2_sub30_4_head1/weights/train-100.pt', help='pretrained weight path')    
    ...
    parser.add_argument('--exp_name', default='humanact12_SIM_MIM_MOT_patch2_sub30_4_head1', help='save to project/name')
