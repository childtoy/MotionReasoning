...
def train(opt, device):
    ...
    train_dataset = HumanAct12Dataset2(data_path="/home/taehyun/workspace/childtoy2/MotionReasoning/dataset/experiment/HumanAct12Poses/humanact12poses.pkl", motion_length=150, dataset="train", transform=None)
...
def parse_opt():
    ...
    parser.add_argument('--exp_name', default='humanact12_SIM_MIM_MOT_patch2_512_noaug', help='save to project/name')
